...
*router.delete ('/delete/:id') (para eliminar vendedores que no tienen ventas -- ( id: nuemro 8 y 9 los cree sin ventas, puede probar con esos id) para no afectar la integridad)
